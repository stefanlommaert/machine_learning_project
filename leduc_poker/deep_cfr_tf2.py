...
def main(unused_argv):
  ...
  average_policy = policy.tabular_policy_from_callable( #deep_cfr_solver.action_probabilities(state) is magish en geeft gewoon simple welke acties ge moet doen.. 
